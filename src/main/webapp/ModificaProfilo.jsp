...
<%}%>
<div class="container">
<h5 class="display-3 text-center py-3">Modifica Profilo</h5>
</div>
<div class="container rounded bg-white mt-5 mb-5 border border-success rounded py-2">
     ...
     <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <form id="GestioneProfilo" action="ModificaProfiloServlet" method="post">
                    ...
                    <button class="btn btn-outline-success btn-lg px-5" type="submit" id="save-profile-btn">Save Profile</button>
                    </div>
            </div>
            </form>
        </div>
