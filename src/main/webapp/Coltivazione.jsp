    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Generale
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"
                    type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Dati Umidità
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane"
                    type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Dati Ph
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="contact-tab2" data-bs-toggle="tab" data-bs-target="#contact-tab-pane2"
                    type="button" role="tab" aria-controls="contact-tab-pane2" aria-selected="false">Dati Temperatura
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="contact-tab3" data-bs-toggle="tab" data-bs-target="#contact-tab-pane3"
                    type="button" role="tab" aria-controls="contact-tab-pane3" aria-selected="false">Fisiopatie
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="disabled-tab" data-bs-toggle="tab" data-bs-target="#disabled-tab-pane"
                    type="button" role="tab" aria-controls="disabled-tab-pane4" aria-selected="false">Storico
            </button>
        </li>
    </ul>
    <div id="row">
                    ...
                    <div class="card-body">
                        <div style="width: auto;" class="row">
                            <div class="col-sm-6">
                                ...
                                <h7>Coltivazione di <%=nomePianta%>
                                </h7>
                                <br>
                                <img src="<%=urlImmagine%>" alt="Foto coltivazione"/><br>
                                <h7>Terreno: <%=descrizioneTerreno%>
                                </h7>
                                <br>
                                <h7>Data inizio: <%=temporaryColtivazioneBean.getData_inizio()%>
                                </h7>
                                <br>
                            </div>
                            <div class="col-sm-6">
        ...
        <div class="col-sm-6">
                        ...
                        <div style="width: auto;" class="row">
                            ...
                            */%>
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <h5>Media</h5>
                                <div style="width: 50%; height: 20px; background-color: #ddd;display: flex; align-items: center;">
                                    <div style="width: <%=resultTemperatura%>%; height: 20px; background-color: <%=resultTemperatura%>;"></div>
                                    <%=resultTemperatura%>&degC
                                    <div style="width: 10px; height: 10px; background-color: <%=colorTemperatura%>; border-radius: 50%;"></div>
                                </div>
                            </div>
            ...
            <!-- Fisiopatie -->
            <div class="tab-pane fade" id="contact-tab-pane3" role="tabpanel" aria-labelledby="contact-tab3"
                 tabindex="0">
                <div class="card" style="width: auto;">
                    <div class="card-body">
                        <%
        ...
        <div class="tab-pane fade" id="contact-tab-pane3" role="tabpanel" aria-labelledby="contact-tab4" tabindex="0">>
            ...
            <form method="ServletColtivazioni" action="post">
                ...
                <button id="rilevamentiPerPeriodo" type="button" class="btn btn-success">Mostra per questi periodi
                </button>
            </form>
