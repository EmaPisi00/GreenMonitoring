<%@ page import="it.unisa.greenmonitoring.businesslogic.gestioneautenticazione.GeneraCodice.GeneraCodiceRandom" %>
...
<div class="container py-4 h100 " style="width: 65%">
    <div class="row justify-content-center align-items-center h-100" style="width: 100%;">
        ...
        <div class="card text-black" style="border-radius: 1rem; border: 2px solid green; font-size:  22px; ">
            ...
            <form class="row g-3 " action="RegistrazioneAziendaServlet" style="font-family: 'Lora', serif;"
                  method="post">
                ...
                <div class="col-md-12">
                    <div class="form-outline form-white mb-4">
                        ...
                        <input style=" background-color: rgb(208, 213, 218);" type="text"
                               class="form-control border-secondary" id="inputAzienda" placeholder="Montenegro"
                ...
                <div class="col-md-12">
                    <div class="form-outline form-white mb-4">
                        ...
                        <input style=" background-color: rgb(208, 213, 218);" type="text"
                               class="form-control border-secondary" id="inputPartitaIva" placeholder="111111111111"
                ...
                <div class="col-md-12">
                    <div class="form-outline form-white mb-4">
                        ...
                        <input style=" background-color: rgb(208, 213, 218);" type="text"
                               class="form-control border-secondary" id="inputEmail" placeholder="emanuele@x.com"
                ...
                <div class="col-md-6">
                    <div class="form-outline form-white mb-4">
                        ...
                        <input style=" background-color: rgb(208, 213, 218);" type="password"
                               class="form-control border-secondary" id="inputPassword" placeholder="*****"
                ...
                <div class="col-md-6">
                    <div class="form-outline form-white mb-4">
                        ...
                        <input style=" background-color: rgb(208, 213, 218);" type="password"
                               class="form-control border-secondary" id="confermaInputPassword" placeholder="*****"
                ...
                <div class="col-12">
                    <div class="form-outline form-white mb-4">
                        ...
                        <input style=" background-color: rgb(208, 213, 218);" type="text"
                               class="form-control border-secondary" id="inputIndirizzo" placeholder="Via Roma 13"
                ...
                <div class="col-md-12">
                    <div class="form-outline form-white mb-4">
                        ...
                        <input style=" background-color: rgb(208, 213, 218);" type="text"
                               class="form-control border-secondary" id="inputCitta" placeholder="Salerno" required=""
                               name="inputCitta"/>
                    </div>
                </div>
                <div class="col-md-12">
                    ...
                    <input style=" background-color: rgb(208, 213, 218);" type="text"
                           class="form-control border-secondary" id="inputProvincia" placeholder="Napoli" required=""
                           name="inputProvincia"/>
                </div>
                <div class="col-md-12">
                    <div class="form-outline form-white mb-4">
                        ...
                        <input style=" background-color: rgb(208, 213, 218);" type="text"
                               class="form-control border-secondary" id="inputTelefono" placeholder="3457257849"
                               required="" name="inputTelefono" value="+39 "/>
                    </div>
                </div>
